...
export default Vue.extend({
  ...
  data: () => ({
    ...
    value_block1: [200, 675, 410, 390, 310, 460, 250, 240],
    labels_block2: [
      "Janvier",
      "Février",
      "Mars",
    ...
    value_block2: [200, 675, 410, 390, 310, 460, 250, 240, 210, 180, 140, 90],
    labels_block3: [
      "Jan",
      "Fév",
      "Mar",
    ...
    value_block3: [200, 675, 410, 390, 310, 460, 250, 240, 210, 180, 140, 90],
    value_block4: [90, 140, 180, 210, 240, 250, 200, 310, 390, 410, 675, 460],
  }),
  beforeCreate() {
